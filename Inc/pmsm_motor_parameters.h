...
#define RS                     1.86 /* Stator resistance , ohm*/
#define LS                     0.000518 /* Stator inductance, H
...
#define NOMINAL_CURRENT         20554
#define MOTOR_MAX_SPEED_RPM     3000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  5.5 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -20554 /*!< Demagnetization current */
